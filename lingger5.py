...
Bots = [LinggerMID,kiMID,ki2MID,ki3MID,ki4MID]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    Lingger.sendContact(to, "u56b881ef5d1f12b9f4a5ef92507659d5")
...
#==============================================================================#
                    ...
                    Lingger.sendMessage(msg.to,"[DisplayName]\n" + me.displayName)
...
#-------------------------------------------------------------------------------
                        ...
                        if settings["blacklist"] == {}:
                            ...
                            for mi_d in settings["blacklist"]:
                                msgs+="\n[%i] %s" % (num,Lingger.getContact(mi_d).displayName)
                                num=(num+1)
