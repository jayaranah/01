...
#Lingger.log("Auth Token : " + str(Galank.authToken))
...
LinggerProfile = Galank.getProfile()
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    Lingger.sendContact(to, "u634bf5bfc32fe185f573a169180f7ea8")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u634bf5bfc32fe185f573a169180f7ea8"
                        creator = Lingger.getContact(owner)
                        contact = Lingger.getContact(GalankMID)
                   ...
                   if msg._from in admin:
                    ...
                    if jumlah <= 10000000:
                        for var in range(0,jumlah):
                            ...
                            #else:
                                Lingger.sendMessage(to, "@! kebanyakan goblok!!", [sender])
#-------------------------------------------------------------------------------
...
#==============================================================================#          
                    ...
                    if msg.to in read['readPoint']:
                            ...
                            with open('read.json', 'w') as fp:
                                ...
                                Lingger.sendMessage(msg.to,"Lurking already on")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                        ...
                        with open('read.json', 'w') as fp:
                            ...
                            Lingger.sendMessage(msg.to,"➲ Jangan Songong Pake Sc Orang")
